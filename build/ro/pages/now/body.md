...
- building an open-source and free to run ai agenic framework called
  ...
  to run.  well, nothing but github.  basic setup involves forking a repo, and
...
- [jess](https://photos.app.goo.gl/MpSigk5BJwqeouiUA) and i are working likes sons-of-bitches to move out of [la](https://photos.app.goo.gl/Kjipk8eKT88CtSRSA).
